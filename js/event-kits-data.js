      ...
      steps: [
        {
          id: "date",
          title: "親人過世多久了？",
          prompt: "期限會影響死亡登記、拋棄繼承與遺產稅申報。先把日期釘住。",
          options: [
            {
              label: "30 日內",
        ...
        },
        {
          id: "conflict",
          title: "繼承人之間是否已有爭議？",
          prompt: "有爭議時，文件保存與分割順序會比快速過戶更重要。",
          options: [
            {
              label: "大家有共識",
      ...
      steps: [
        {
          id: "status",
          title: "目前是否已談好離婚？",
          prompt: "離婚合意程度會影響是先補協議，還是要準備談判或法院程序。",
          options: [
            {
              label: "已談好，準備簽協議",
      ...
      steps: [
        {
          ...
          options: [
            {
              label: "剛發生事故",
              note: "優先報案、就醫、保存現場照片與行車紀錄器資料。",
              flags: ["保存證據", "取得事故資料"],
              actions: ["報案並取得受理資料", "拍攝車損、路口、號誌、煞車痕與現場位置", "先就醫並請醫師記載受傷部位"],
              documents: ["報案資料", "現場照片", "行車紀錄器影片", "診斷證明"],
              toolKeys: []
            },
            {
              label: "正在治療中",
              note: "先累積診斷證明、醫療收據、請假與薪資損失資料。",
              flags: ["醫療證明", "薪資損失"],
              actions: ["每次回診保留診斷證明與收據", "整理請假紀錄與薪資減少證明", "如果需要照護，記錄看護天數與費用"],
              documents: ["診斷證明", "醫療收據", "請假紀錄", "薪資證明", "看護紀錄"],
              toolKeys: ["caregiver"]
            },
            {
              label: "正在談和解",
              note: "先確認肇責、傷勢是否穩定、求償項目是否完整。",
              flags: ["和解評估", "避免過早簽署"],
              actions: ["列出醫療費、交通費、工作損失、看護費與慰撫金", "確認傷勢是否已穩定，不以口頭承諾替代書面內容", "簽名前逐條檢查和解書是否放棄後續請求"],
              documents: ["和解書草稿", "損害明細", "保險聯繫紀錄", "肇責資料"],
        ...
        },
        {
          ...
          options: [
            {
              label: "只有車損或財損",
              note: "先整理維修估價、照片、事故資料與責任比例。",
              flags: ["財損資料"],
              actions: ["取得維修估價單或發票", "保存受損物照片與購買紀錄", "用肇責比例估算可請求金額"],
              documents: ["維修估價單", "車損照片", "財物購買紀錄", "事故初判表"],
              toolKeys: ["settlement-calc"]
            },
            {
              label: "輕傷，已就醫",
              note: "保留診斷證明與收據，後續可估算醫療費與慰撫金範圍。",
              flags: ["醫療費", "慰撫金"],
              actions: ["彙整醫療費與交通費", "記錄請假與無法工作的期間", "初步估算求償項目，不只看修車費"],
              documents: ["醫療收據", "診斷證明", "交通支出", "請假紀錄"],
              toolKeys: ["accident"]
            },
            {
              label: "重傷或仍在復健",
              note: "暫不宜急著和解，應整理長期治療、看護與工作損失資料。",
              flags: ["高風險", "建議諮詢律師"],
              actions: ["先確認後續治療與復健期間", "估算看護費與長期工作損失", "在傷勢未穩定前暫緩簽終局和解"],
              documents: ["完整病歷", "復健紀錄", "看護費資料", "工作能力受影響證明"],
        ...
        },
        {
          ...
          options: [
            ...
            {
              label: "還沒有初判表",
              note: "先取得警方資料與保險聯繫紀錄，再進入金額協商。",
              flags: ["先補資料"],
              actions: ["向警方確認事故資料申請方式", "先整理證據，不急著接受固定比例", "與保險公司聯繫時留下書面紀錄"],
              documents: ["報案資料", "現場證據", "保險聯繫紀錄"],
              toolKeys: []
            },
            {
              label: "雙方對肇責有爭議",
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              flags: ["先補通知"],
              actions: ["立即用平台訊息或 Email 通知", "文字中寫明訂單、商品與請求", "保存送出時間"],
        ...
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              flags: ["證據可補"],
              actions: ["立即補拍全景與細節照片", "保存通知房東的時間", "取得修繕估價或第三方說明"],
